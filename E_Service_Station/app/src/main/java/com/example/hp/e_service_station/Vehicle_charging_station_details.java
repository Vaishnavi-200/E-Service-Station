...
public class Vehicle_charging_station_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn=(Button)findViewById(R.id.btn_vcs);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(),Direction_vcs_page.class);
                startActivity(i);
            }
        });
    ...
    private void getProductByCode(final String string_charge)
    {
        ...
        call.enqueue(new Callback<List<ChargeArray>>() {
            ...
            public void onResponse(Call<List<ChargeArray>> call, Response<List<ChargeArray>> response) {
                ...
                if (isSuccess) {
                    t1.setText("station id : "+productList_vsc.get(0).getstationid());
                    t2.setText("station name : "+ productList_vsc.get(0).getstationname());
                    ...
                    t6.setText("station details : "+productList_vsc.get(0).getportdetails());
                    t7.setText("charging charge"+productList_vsc.get(0).getchargingcharge());
