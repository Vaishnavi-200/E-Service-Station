...
if(isset($_POST['submit']))
{
    ...
    $Sql=mysqli_query($conn,"INSERT INTO TABLE_ADMIN VALUES('$v1','$v2','$v3','$v4','$v5','$v6')");
    if($Sql)
    {
        echo "Data Inserted";
    }
...
<tr>
    ...
    <td><input type='text' name='f4' maxlength="10" pattern="[6789][0-9]{9}"></td>
</tr>
<tr> <td>&nbsp;</td> </tr>
<tr>
...
<tr>
    ...
    <td><input type='Password' name='f6'></td>
</tr>
<tr> <td>&nbsp;</td> </tr>
