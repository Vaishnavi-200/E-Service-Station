...
if(isset($_POST['submit']))
{
    ...
    $v1=stripcslashes($v1); 
     ...
     $sql="select * from TABLE_ADMIN where MobileNumber='$v1' and Password='$v2'";
...
<body>
  ...
  <center>
   <form method="post"><br>
      <strong><h3>
        <label>E Service Station Admin</label><br>
      ...
      <input type="Mobile" name="f1" maxlength="10" pattern="[6789][0-9]{9}"><br><br>
      ...
      <a href="signup_page.php"><input type="button" name="submit" value="New User Account"/></a><br><br
